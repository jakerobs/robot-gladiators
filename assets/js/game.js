    ...
    switch (shopOptionPrompt) {
        ...
        case "upgrade":
            if (playerInfo.money >= 7) {
                ...
                // increease attack and decrease money
        ...
        case "leave":
            ...
            break;
        default:
            window.alert("You did not pick a valid opciton. Try again.");

            //call shop() agian to force plaer to pick a valid option
            shop();
            break;
    }
};

// generate a random numeric value funtion
